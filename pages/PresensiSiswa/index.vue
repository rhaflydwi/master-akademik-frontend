  ...
  <div class="container-fluid" @load="startTime()">
          ...
          <div class="card border-left-info shadow py-2" style="width: 72rem;">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-info text-uppercase mb-10" align="center">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Data Presensi Seluruh Siswa</h6>
      </div>
      <div class="card-body">
...
async asyncData({store}) {
  ...
  methods: {
    ...mapActions('presensi', ['getPresensiData']),
