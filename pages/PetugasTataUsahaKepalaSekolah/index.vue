...
export default {
    ...
    async asyncData({store}) {
        await Promise.all([
            store.dispatch('UserPetugastatausaha/getUsersData')
        ])
        return
    },
    data() {
    ...
    methods: {
        ...mapActions('UserPetugastatausaha', ['getUsersData', 'destroyUsersData']),
        ...mapMutations('UserPetugastatausaha', ['SET_PAGE']),
