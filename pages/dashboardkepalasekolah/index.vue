                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{buku.total}} Buku</div>
                                        </div>
                                        <div class="col-auto">
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p><b>Status User : <span style="color:green">{{ "Kepala Sekolah" }}</span></b></p>
