        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title m-0 font-weight-bold text-primary"><i class="fa fa-book" aria-hidden="true"></i>
                    List Buku
                    <nuxt-link class="btn btn-primary float-right btn-sm" :to="{name: 'BukuKepalaSekolah-add'}">Add New</nuxt-link>
                </h2>
            </div>
                ...
                <div class="col-md-12">
                    <b-table striped hover :items="buku.data" :fields="fields" show-empty responsive>
                        ...
                        <template v-slot:cell(actions)="row">
                            ...
                            <nuxt-link :to="{name: 'BukuKepalaSekolah-edit-id', params: {id: row.item.id}}" :key="'edit'+row.index" class="btn btn-warning btn-sm">Edit</nuxt-link>
...
export default {
    ...
    data() {
        return {
            ...
            fields: ['judul','penerbit', 'penanggung_jawab', 'actions'], 
            items: [],
            deleteModal: false, 
