...
export default {
        created() {
            if (this.$route.name == 'BukuPerpustakaan-edit-id') {
                this.buku = {
                id: this.bukus.id,
       ...
       ...mapActions('bukus', ['storeBukuData', 'updateBukusData']),
        submit() {
            if (this.$route.name == 'BukuPerpustakaan-edit-id') {
                ...
                this.updateBukusData(data).then((this.$router.push({name: 'BukuPerpustakaan'})))
            } else {
                this.storeBukuData(this.buku).then(() => this.$router.push({name: 'BukuPerpustakaan'}))
                    }
                }
            }
}
